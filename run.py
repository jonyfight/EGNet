...
if __name__ == '__main__':
    ...
    vgg_path = 'E:/Smart Image Project/EG-NET/vgg16_20M.pth'  # /home/liuj/code/Messal/weights/vgg16_20M.pth
    resnet_path = 'E:/Smart Image Project/EG-NET/resnet50_caffe.pth'  # /home/liuj/code/Messal/weights/resnet50_caffe.pth
    ...
    parser.add_argument('--batch_size', type=int, default=1)  # 1
    ...
    # Testing settings
    parser.add_argument('--model', type=str, default='E:/Smart Image Project/EG-NET/epoch_resnet.pth')  # ./epoch_resnet.pth
    parser.add_argument('--test_fold', type=str, default='E:/Smart Image Project/EG-NET/results')  # ./results/test
    parser.add_argument('--test_mode', type=int, default=1)  # 1
    parser.add_argument('--sal_mode', type=str, default='e')  # t
